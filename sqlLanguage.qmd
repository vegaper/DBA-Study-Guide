...
La subconsulta se evalúa primero; su resultado se usa como criterio de filtro en la consulta externa.
...
Hay que tener en cuenta que parte se ejecuta antes y cuál después, por ejemplo en este ejemplo tenemos el mismo cálculo, que es la media del salario, pero el valor que está calculado con una subconsulta se calcula ANTES de filtrar los registros con la condición del WHERE, mientras que la media que se calcula sin subconsulta se calcula sobre el subset de los registros filtrados.
...
- Se ejecuta primero: La subconsulta interna genera un conjunto de resultados completo.
