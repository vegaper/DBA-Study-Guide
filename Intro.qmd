...
3\. **Puerta de Enlace Predeterminada:** Generalmente se le da la primera dirección disponible (ej. `192.168.1.1`) y corresponde al router \[7, 11\].
...
## 5. Capa de Transporte: Puertos y Protocolos (TCP vs UDP)
