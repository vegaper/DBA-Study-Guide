...
Los dispositivos solo pueden comunicarse con otros dentro de la misma VLAN.
Para comunicar VLAN entre sí, necesitas un router o un switch capa 3 (inter‑VLAN routing).

Beneficios principales
-  Seguridad: Aísla grupos de dispositivos.
Ejemplo:
...
5. Abrir la terminal y actualizar el repositorio para evitar errores de compilación:
   ```bash
   sudo apt update
   sudo apt upgrade
    ```
...
```
7. Volver al explorador y ejecutar nuevamente `autorun.sh.`
