...
## Las tres clases de ciudadanos en Linux

Para entender el sistema, clasifiquemos a los "habitantes" del castillo:

1.  **root (El Rey):** UID 0. Poder total. Es el único que puede hacer cambios estructurales en el sistema.

2.  **Usuarios Humanos:** Creados para que tú (o tus compañeros) interactúen con el sistema. Tienen un `home` asignado y permisos para ejecutar aplicaciones de escritorio, programar, etc.

3.  **Usuarios de Sistema o Servicio:** Son los "fantasmas" del sistema. No son humanos. Corren procesos como servidores web (Apache/Nginx), bases de datos (MySQL/PostgreSQL) o tareas de red.
...
## El Usuario Inicial (Tu "Administrador Humano")

Cuando instalas Linux, el sistema te obliga a crear un usuario. Este usuario es especial:
...
-   **Uso diario:** Úsalo siempre para trabajar.

## 4. Comparativa: root vs. Usuario Inicial
